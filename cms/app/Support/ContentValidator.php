    ...
    public static function validate(string $kind, array $data, string $key = ''): void
    {
        ...
        if ($kind === 'page') {
            $rules = array_merge($rules, [
                ...
                'guideType' => 'nullable|required_if:template,guide|in:overview,food,sights,museums,itinerary,family,souvenirs',
                'listTitle' => 'nullable|string|max:250',
                'sourceLabel' => 'nullable|string|max:250',
                'noteTitle' => 'nullable|string|max:250',
                'noteText' => 'nullable|string|max:1000',
                'closingTitle' => 'nullable|string|max:250',
                'closingText' => 'nullable|string|max:1000',
