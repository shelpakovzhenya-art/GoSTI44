...
import { Foliage } from "@/components/brand";
...
export function WhyTangerine() {
  ...
  return <section className="section why-section botanical-section" id="comfort">
    <Foliage className="why-palm" variant="palm"/>
...
export function Spa() {
  const {site}=useSite();
  return <section className="spa-section section botanical-section" id="spa"><Image className="section-backdrop" src="/images/spa-tea.jpg" alt="" fill sizes="100vw"/><Foliage className="spa-leaves" variant="palm"/><div className="container spa-grid">
...
export function ExtraServices() {
  ...
  return <section className="services-section section botanical-section" id="services"><Foliage className="services-fruit" variant="lemons"/><div className="container">
