...
export default function Landing() {
  ...
  return <div id="top"><ScrollReveal/><Navigation/><main id="main">
    ...
    <section className="section about-band botanical-section" id="about"><div className="container about"><div className="about-editorial-photo"><Image src="/images/hero.jpg" alt="Общий сад и территория у таунхаусов «Танжерин»" fill sizes="(max-width:760px) 100vw, 40vw"/></div>
