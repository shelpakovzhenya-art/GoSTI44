...
- Активный release: `/var/www/gosti/releases/20260918-2`; frontend собран из `b9a3b84`, CMS-миграции синхронизированы до `0c64bc5`.
- CMS: `/var/www/gosti/releases/20260918-2/cms`; база: `/var/www/gosti/shared/database.sqlite`; постоянное storage: `/var/www/gosti/releases/20260909-1/cms/storage`.
...
- Предыдущий release для отката: `/var/www/gosti/releases/20260918-1`.
