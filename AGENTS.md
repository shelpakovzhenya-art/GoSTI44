...
- На текущей машине пользователь разрешил создавать файлы в этом проекте на C:. Ограничение D:/Codex относится к другому компьютеру. Защищённые исходники и историю не удалять ради освобождения места.
